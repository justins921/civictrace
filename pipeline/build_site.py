...
# Everything below here builds the standalone HTML artefact and only runs when
# this file is executed directly.
#
# export_json.py and timing.py both `from build_site import cand_for` — six
# lines of candidate-ID lookup — and without this guard that import ran the
# whole module: collect() built every trail for every member and a 700 KB file
# was written to disk, twice per refresh, as a side effect of importing a
# helper. Every trail was constructed three times per run.
